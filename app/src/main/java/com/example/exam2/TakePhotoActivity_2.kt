...
class TakePhotoActivity_2 : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.takephoto_2)
        ...
        object : CountDownTimer(totalMs.toLong(), 50L) {
            ...
            override fun onFinish() {
                ...
                if (shotIndex < totalShots) {
                    ...
                    // 모든 샷 끝나면  printphoto 화면으로 이동
                    val intent = Intent(this@TakePhotoActivity_2, PrintPhotoActivity::class.java).apply {
                        putStringArrayListExtra("photo_paths", ArrayList(capturedPhotoPaths))
                        putExtra("frame_type", 2)
                    }
